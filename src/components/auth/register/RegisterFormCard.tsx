...
import {BadgeCheck, KeyRound, Loader2, PhoneIcon, RotateCcwKey} from "lucide-react";
...
const Separator = () => {
    return (
        <div className="flex items-center gap-4 my-4">
            ...
            <span className="text-text-muted text-xs font-medium uppercase tracking-wide">or</span>
            <div className="flex-1 h-px bg-text-muted"/>
        </div>
    );
}
...
export function RegisterFormCard() {
    ...
    return (
        <Card
            className={'border-border-light shadow-[0_1px_3px_rgba(0,0,0,0.04),0_4px_12px_rgba(0,0,0,0.04),0_12px_32px_rgba(0,0,0,0.06)] rounded-3xl animate-slide-up'}>
