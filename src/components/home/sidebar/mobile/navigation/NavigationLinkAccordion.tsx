...
const NavigableLinkInner = ({
  ...
  <Link
    ...
    className="flex items-center gap-2 flex-1 hover:bg-surface-variant transition-colors rounded-panel"
  >
    <div
      className={cn(
    ...
    return (
      ...
      >
        <AccordionItem value={'item-1'} className={'border-0'}>
          <div
            className={
              'h-9 group relative flex items-center gap-2 transition-all duration-200 pl-1'
            }
          >
            {inSheet ? (
              <SheetClose asChild>
  ...
  return (
    <Accordion type="single" collapsible className="w-full border-0">
      <AccordionItem value={'item-1'} className={'border-0'}>
        <AccordionTrigger
          className={
            'p-0 hover:bg-surface-variant rounded-panel transition-colors'
          }
        >
          <div
            className={
              'h-9 group relative flex items-center gap-2 transition-all duration-200 px-1'
            }
          >
            {navigationItem.icon && (
              <div
