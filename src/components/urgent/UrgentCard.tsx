...
const UrgentCard = ({content, createdBy, id}: UrgentItem) => {
    return (
        <li className={"flex flex-col justify-evenly mx-4 border border-gray-200 rounded-lg"}>
            <div className="font-medium flex items-center px-3 py-2 bg-blue-300/10">
                ...
                <Button variant={"outline"} className="ml-auto h-8 px-3 rounded-lg" onClick={() => UrgentService.resolve(id)}>შესრულებულია</Button>
            </div>
