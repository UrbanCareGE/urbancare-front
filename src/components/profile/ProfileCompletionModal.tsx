...
const profileSchema = z.object({
    name: z.string().min(2, {message: "სახელი უნდა შედგებოდეს მინიმუმ 2 ასოსგან"}),
    surname: z.string().min(2, {message: "გვარი უნდა შედგებოდეს მინიმუმ 2 ასოსგან"}),
});
...
export function ProfileCompletionModal() {
    ...
    useEffect(() => {
        if (isAuthenticated && user) {
            ...
            const needsCompletion = !user.name || !user.surname ||
                                    user.name.trim() === '' ||
                                    user.surname.trim() === '';
