  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {title && <h1 className="font-semibold urbancare-text-2xl">{title}</h1>}
        {children}
      </div>
      ...
      {showClose && (
        <button
          onClick={onClose}
          className="p-1.5 lg:hover:bg-surface-variant urbancare-rounded-full transition-colors text-foreground-secondary lg:hover:text-foreground-primary"
        >
          <X className="h-5 w-1" />
        </button>
      )}
