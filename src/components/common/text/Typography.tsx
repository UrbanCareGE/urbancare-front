...
export const TypographyH1: React.FC<TypographyProps> = ({
  ...
  return (
    <h1
      className={cn(
        'scroll-m-20 text-center urbancare-text-10xl font-semi tracking-tight text-balance',
        className
      )}
    >
      {children}
...
export const TypographyH2: React.FC<TypographyProps> = ({
  ...
  return (
    <h2
      className={cn(
        'urbancare-text-8xl font-semibold tracking-tight',
        className
      )}
    >
      {children}
...
export const TypographyH3: React.FC<TypographyProps> = ({
  ...
  return (
    <h3
      className={cn(
        'scroll-m-20 urbancare-text-7xl font-semibold tracking-tight',
        className
      )}
    >
      {children}
...
export const TypographyH4: React.FC<TypographyProps> = ({
  ...
  return (
    <h4
      className={cn(
        'scroll-m-20 urbancare-text-3xl font-semibold tracking-tight',
        className
      )}
    >
      {children}
...
export const TypographyLead: React.FC<TypographyProps> = ({
  ...
  return (
    <p className={cn('text-muted-foreground urbancare-text-3xl', className)}>
      {children}
    </p>
  );
};
...
export const TypographyLarge: React.FC<TypographyProps> = ({
  ...
  return (
    <div className={cn('urbancare-text-2xl font-semibold', className)}>
      {children}
    </div>
  );
};
...
export const TypographySmall: React.FC<TypographyProps> = ({
  ...
  return (
    <small
      className={cn('urbancare-text-base leading-none font-medium', className)}
    >
      {children}
    </small>
  );
...
export const TypographyMuted: React.FC<TypographyProps> = ({
  ...
  return (
    <p className={cn('text-muted-foreground urbancare-text-base', className)}>
      {children}
    </p>
  );
};
