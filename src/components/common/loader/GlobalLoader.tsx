  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        {/* Logo */}
        <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-200 animate-pulse">
          <svg
...
export function SpinnerLoader() {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-emerald-50 via-white to-teal-50 z-50 flex items-center justify-center">
      <div className="flex flex-col items-center gap-6">
        {/* Logo */}
        <div className="w-20 h-20 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-200">
          <svg
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-10 h-10 border-4 border-transparent border-t-emerald-500 rounded-full animate-spin" />
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl flex flex-col items-center gap-3">
          <div className="relative">
            <div className="w-8 h-8 border-3 border-emerald-100 rounded-full" />
            <div className="absolute top-0 left-0 w-8 h-8 border-3 border-transparent border-t-emerald-500 rounded-full animate-spin" />
          </div>
