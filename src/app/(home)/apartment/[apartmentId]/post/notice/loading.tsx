  ...
  return (
    <div className="flex-1 w-full bg-background space-y-4 py-4">
      <div className="max-w-2xl mx-auto px-4 space-y-4">
        ...
        <div className="flex shadow-sm border border-border bg-surface rounded-panel animate-pulse p-3 items-center">
          <div className="w-12 h-12 rounded-full bg-surface-container flex-shrink-0" />
          <div className="flex-1 px-4 py-3">
            <div className="bg-surface-container rounded-xl h-6 w-full mr-auto" />
          </div>
        </div>
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="bg-surface rounded-panel border border-border p-4 animate-pulse"
          >
