...
export default function DesktopLayout({
  ...
  ], [t.authPages.digitalManagement, t.authPages.neighborCommunication, t.authPages.votingDiscussions]);

  return (
    <div className="relative min-h-dvn bg-background">
      <div className="hidden lg:flex lg:h-dvh lg:overflow-hidden">
        ...
        <div className="relative flex flex-col w-[56%] overflow-hidden bg-gradient-primary">
          ...
          {/* Ambient blobs */}
          <div
            className="absolute -top-28 -left-28 w-80 h-80 bg-white/5 rounded-urbancare-full blur-[90px] animate-blob" />
          <div
            className="absolute top-1/2 -right-20 w-72 h-72 bg-white/5 rounded-urbancare-full blur-[90px] animate-blob animation-delay-2000" />
          <div
            className="absolute -bottom-20 left-1/3 w-64 h-64 bg-white/5 rounded-urbancare-full blur-[90px] animate-blob animation-delay-4000" />
              ...
              <div className="flex flex-col gap-3">
                {features.map((f, i) => (
                  <div key={i} className="flex items-center gap-4">
                    <div
                      className="w-10 h-10 rounded-urbancare-xl bg-white/15 backdrop-blur-sm flex items-center justify-center text-white shrink-0">
                      {f.icon}
                    </div>
        ...
        {/* RIGHT FORM PANEL */}
        <main
          className="flex-1 flex flex-col items-center justify-center overflow-y-auto bg-background px-10 py-10">
